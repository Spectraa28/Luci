...
Skill installer - try anyone's skill in one command 
    ...
    python -m luci skill install https://github.com/<user>/<repo>/blob/main/skills/foo/SKILL.md
    
Download the SKILL.md , validate the frontmatter , and drops it in LUCI_HOME/skills/<name>/ where the loader 
...
from luci.memory.procedural.loader import _parse
...
def install(url: str) -> None:
    ...
    print("It loads next time luci starts. Read it first — skills are instructions.")