...
from luci.memory.procedural import installer
from luci.memory.procedural.loader import SkillLoader
from luci.ops.dashboard import memory_action
from luci.tools.memory_admin import make_create_skill_tool
...
def test_installed_skill_is_written_as_utf8(
    ...
    monkeypatch.setenv("LUCI_HOME", str(home))
