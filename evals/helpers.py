"""
Shared eval plumbing : a scripted fake llm client for offline tests and

a real luci factory for live ones.
"""
...
def make_luci(home: Path, client=None, **settings_overrides):
    """Build a luci with an isolated home dir; optionally swap in a fake client."""
    ...
    return luci(settings=settings, client=client)