"""MCP connector — plug any Model Context Protocol server into Luci's tools.

Luci's loop is synchronous; the MCP SDK is async. The bridge below runs one
